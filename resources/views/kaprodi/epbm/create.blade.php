...
@section('title', 'Buat Periode EPBM')

@section('content')
<div class="px-4 py-5 sm:px-6">
    <h1 class="text-2xl font-bold text-gray-900">Buat Periode EPBM Baru</h1>
</div>

<div class="px-4 sm:px-6">
    <div class="bg-white shadow sm:rounded-lg p-6 max-w-lg">
        <form action="{{ route('kaprodi.epbm.store') }}" method="POST">
            @csrf
            
            <div class="mb-4">
                <label for="nama_periode" class="block text-sm font-medium text-gray-700">Nama Periode</label>
                <input type="text" name="nama_periode" id="nama_periode" value="{{ old('nama_periode') }}" required placeholder="Contoh: Ganjil 2024/2025"
